...
(function () {
    var c = function () {
        ...
        e.push(c.options);
        if (e[0].match(/^\s*#([\w:\-\.]+)\s*$/gim)) {
            e[0].replace(/^\s*#([\w:\-\.]+)\s*$/gim, function (h, i) {
                var f = document;
    ...
    c.set = function (f, j) {
        var h = this;
        var e = function (i) {
            return i.replace(/[\$\(\)\[\]\+\^\{\}\?\*\|\.]/gim, function (l) {
                return '\\' + l;
            });
        };
        var k = function (l, m) {
    ...
    c.template = function (e) {
        ...
        this.__lexicalAnalyze = function (k) {
            ...
            k.replace(c.settings.forstart, h).replace(c.settings.interpolate, h).replace(c.settings.ifstart, h).replace(c.settings.elseifstart, h).replace(c.settings.include, h).replace(/[\+\-\*\/%!\?\|\^&~<>=,\(\)\[\]]\s*([A-Za-z_]+)/gim, h);
...
(function () {
    ...
    templates['main.juicer'] = function (_, _method) {
        var __escapehtml = {
            escapehash: {
                '<': '&lt;',
                '>': '&gt;',
        ...
        try {
            ...
            var br = _.br;
            var div = _.div;
            _out += '<input id="text" type="text" value="http://www.baidu.com" /> <button>提交</button> <br /> <div id="qrcode"></div> ';
        } catch (e) {
...
define('view', [
    ...
    'jquery',
    'qrcode'
], function (_juicer, mainTpl, $, qrcode) {
    var obj = {};
    var $UI = $('body');
    obj.init = function () {
