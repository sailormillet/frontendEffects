...
!function (a, b) {
    ...
    o.fn = o.prototype = {
        ...
        var a,
            ...
            i = arguments.length,
            j = !1;
        for ('boolean' == typeof g && (j = g, g = arguments[h] || {}, h++), 'object' == (typeof g === 'undefined' ? 'undefined' : _typeof(g)) || o.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++) {
    ...
    o.Animation = o.extend(Xb, {
        ...
        var d = a && 'object' == (typeof a === 'undefined' ? 'undefined' : _typeof(a)) ? o.extend({}, a) : {
    ...
    o.fn.load = function (a, b, c) {
        ...
        var d,
            ...
            g = this,
            h = a.indexOf(' ');
        return h >= 0 && (d = a.slice(h), a = a.slice(0, h)), o.isFunction(b) ? (c = b, b = void 0) : b && 'object' == (typeof b === 'undefined' ? 'undefined' : _typeof(b)) && (e = 'POST'), g.length > 0 && o.ajax({
            url: a,
            type: e,
            dataType: 'html',
            data: b
...
define('./js/login', ['bootstrap'], function () {
    return;
});